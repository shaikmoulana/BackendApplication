...
builder.Services.AddScoped<IRepository<ProjectEmployee>, ProjectEmployeeRepository>();
builder.Services.AddScoped<IRepository<ProjectTechnology>, ProjectTechnologyRepository>();
