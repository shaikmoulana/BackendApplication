...
builder.Services.AddScoped<IRepository<POC>, POCRepository>();
builder.Services.AddScoped<IRepository<POCTeam>, POCTeamRepository>();
builder.Services.AddScoped<IRepository<POCTechnology>, POCTechnologyRepository>();
builder.Services.AddScoped<IPOCService, POCService>();
builder.Services.AddScoped<IPOCTeamService, POCTeamService>();
builder.Services.AddScoped<IPOCTechnologyService, POCTechnologyService>();
